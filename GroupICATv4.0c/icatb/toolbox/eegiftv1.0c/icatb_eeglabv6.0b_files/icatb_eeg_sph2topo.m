% icatb_eeg_sph2topo() - Convert from a 3-column headplot file in spherical coordinates
...
%              See  >> help readlocs
% Usage:
%          >> [chan_num,angle,radius] = icatb_eeg_sph2topo(input,shrink_factor,method);
%
% Inputs:
...
% changed name sph2pol() -> icatb_eeg_sph2topo() for compatibility -sm
% 01-25-02 reformated help & license -ad 
% 01-25-02 changed computation so that it works with icatb_eeg_sph2topo -ad 

function [channo,angle,radius] = icatb_eeg_sph2topo(input,factor, method)
