...
### Group ICA/IVA software (MATLAB) v4.0.5.1
...
More information about about the GIFT version history is found at the following link: [GIFT version history](https://github.com/trendscenter/gift/blob/master/doc/updates/README.md) 
