% function icatb_run_conn_ica(sesInfo)
% %% Run FNC ICA
% 
% icatb_defaults;
...
% end
% 
% if ~strcmpi(sesInfo.userInput.modality, 'conn')
%     tmpToolboxName = 'GIFT';
%     if strcmpi(sesInfo.userInput.modality, 'eeg')
%         tmpToolboxName = 'EEGIFT';
%     elseif strcmpi(sesInfo.userInput.modality, 'smri')
%         tmpToolboxName = 'SBM';
%     elseif strcmpi(sesInfo.userInput.modality, 'fnc')
%         tmpToolboxName = 'FNC';
%     end
%     error(['Analysis selected is not CONN ICA. Please use ', tmpToolboxName, ' toolbox.']);
% end
% 
...
% 
% fnc_variable_mat_file = 'conn_matrix';
% 
% 
% 
% %% First PCA step
...
% 
% %% Load FNC data
% fnc_file_name = fullfile(sesInfo.outputDir, [sesInfo.prefix, '_conn_data.mat']);
% 
