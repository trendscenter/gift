...
tagsTobePlotted = {'numComp', 'pc_multiplier', 'algorithm', 'which_analysis', 'backReconType', 'scaleType', 'parallel_info'};
...
figTitle = 'Setup Connectivity ICA';
...
pc_multiplierH = findobj(handles, 'tag', 'pc_multiplier');
