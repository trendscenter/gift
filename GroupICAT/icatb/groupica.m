...
% Last Modified by GUIDE v2.5 10-Feb-2026 21:59:46

icatb_defaults;
global EXIT_GICA_APP;

icatb_delete_gui({'gift', 'eegift', 'sbm', 'fnc_ica_toolbox', 'cdicat'});
...
if (length(varargin) >= 1)
    if ischar(varargin{1})
        ...
        elseif strcmpi(varargin{1}, 'conn')
            ...
            disp('Opening Connectivity ICA toolbox ...');
...
cdicat; %run connectivity domain ica toolbox
