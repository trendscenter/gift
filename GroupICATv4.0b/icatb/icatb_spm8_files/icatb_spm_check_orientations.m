function icatb_spm_check_orientations(V)
% Check the dimensions and orientations of the images
% FORMAT icatb_spm_check_orientations(V)
%
% V - a structure as returned by icatb_spm_vol.
%_______________________________________________________________________
% Copyright (C) 2008 Wellcome Trust Centre for Neuroimaging

% John Ashburner
% $Id: icatb_spm_check_orientations.m 1143 2008-02-07 19:33:33Z spm $
