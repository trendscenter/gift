GroupICATv4.0b Updates (Mar 30, 2020):

Negative eigen values are removed when using GIG-ICA. The following file is updated:

icatb/icatb_analysis_functions/icatb_algorithms/icatb_gigicar.m
